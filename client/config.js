...
export const GAZE_THRESHOLD_RATIO = 0.35;   // Iris position (0.0-1.0, triggers outside [ratio, 1-ratio])
export const LOOKING_AWAY_DURATION_MS = 2000; // Violation must persist (milliseconds)
